            ...
            <div class="profile-card">
                ...
                <div class="profile-body"><!-- profile body section -->
                    ...
                    <div class="card-container">
                        <form action="EditSlider" class="card-row" method="POST">
                            ...
                            <div class="card_form">
                                ...
                                <div class="form_item">
                                    ...
                                    <input name="sliderId" value="${p.sliderId}" hidden>
                                </div>
                                <div class="form_item">
                                ...
                                <div class="form_item">
                                    <span class="form_item_icon bx bx-message-square-edit"></span>
                                    <input name="startDate" type="date" placeholder="Code Product" value="${p.startDate}">
                                </div>
                                <div class="form_item">
                                    <span class="form_item_icon bx bx-message-square-edit"></span>
                                    <input name="endDate" type="date" placeholder="Discount" value="${p.endDate}">
                                </div>
