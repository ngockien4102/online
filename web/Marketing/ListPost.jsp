            ...
            <div class="container1">
                <header class="navbar" id="navbar">
                    ...
                    <ul>
                        ...
                        <li><a href="Slider" class="">Slider</a></li>
                    </ul>
        ...
        <div class="product-list container">
            <div class="row">
                                ...
                                <c:forEach items="${LPost}" var="p">
                                    <div class="post-container">
                                        ...
                                        <c:if test="${p.marketingId == sessionScope.market.marketingId}">
                                            <div>
                                                <a href="PostDetail?blogId=${p.blogId}">View</a>
                ...
                <div class="col-12 col-sm-12 col-md-3 col-lg-3 col-xl-3 product-list-right">
                    <form action="ListFollowAuthor" method="POST">
                    ...
                    <div class="product-categories">
                        ...
                        <ul class="list-group">
                            <c:forEach items="${Author}" var="c">
                                <li class="list-group-item text-white"><a href="ListFollowAuthor?Aname=${c.marketingId}">${c.firstName} ${c.lastName}</a></li>
                                </c:forEach>
                        </ul>
                    </div>
                    <div class="product-categories">
                        <h1>Category</h1>
                        <ul class="list-group">
                            <c:forEach items="${sliders}" var="c">
                                <li class="list-group-item text-white"><a href="ListFollowAuthor?sliderId=${c.sliderId}">${c.title}</a></li>
                                </c:forEach>
                        </ul>
                    </div>
                    <div class="product-categories">
                        <h1>Status</h1>
                        <ul class="list-group">
                            <li class="list-group-item text-white"><a href="ListFollowAuthor?status=1">Activate</a></li>
                            <li class="list-group-item text-white"><a href="ListFollowAuthor?status=0">Expired</a></li>
                        </ul>
                    </div>
                </div>
            </div>
