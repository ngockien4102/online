 ...
 * @author MSII
 */
@WebServlet(name = "EditSliderController", urlPatterns = {"/EditSlider"})
public class EditSliderController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        Slider slider = sliderDao.SliderDetail(sliderId);
        request.setAttribute("p", slider);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        Slider slider = sliderDao.SliderDetail(sliderId);
        if(img.isEmpty()){
            sliderDao.UpdateSlider(title, slider.getImg(), describe, startDate, endDate, sliderId);
            response.sendRedirect("ProfileMKT");
        }else if(!img.isEmpty()){
            sliderDao.UpdateSlider(title, img, describe, startDate, endDate, sliderId);
            response.sendRedirect("ProfileMKT");
        }
    }
