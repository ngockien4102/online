...
public class CartDetailController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        CartContact cartContact = orderDao.CartContacts(id);
        System.out.println(cartContact);
        IProductDao productDao = new ProductDao();
        List<ProductDetail> list6newP = productDao.List6NewProduct();
        request.setAttribute("detail", cartContact);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        IOrderDao orderDao = new OrderDao();
        orderDao.UpdateCart(orderId, quantity);
